...
max_epoch=2400
acc_file_name=  r'clf_score_aps_0LP1N20T_2400mul4.txt'
label_known_rate=0.2
train_rate=0.8
test_rate= 1
model_path=r'/home/xiezheng/Datasets/Sci_Papers/model_aps_0LP1NC20T_2400mul4'
...
for i in range(0,label_known_num):
    Classes[dic_labels[node_origin_label[i]]].append(i)
