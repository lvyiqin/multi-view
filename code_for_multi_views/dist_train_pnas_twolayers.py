...
max_epoch=360
acc_file_name=  r'clf_score_pnas_0LP1N80Tmul4_360_v2_random.txt'
label_known_rate=0.80
train_rate=0.8
test_rate= 1
model_path=r'/home/xiezheng/Datasets/Sci_Papers/model_pnas_0LP1NC80Tmul4_360_v2_random'
...
if __name__ == '__main__':
    ...
    with open(acc_file_name, 'w') as fw:
        ...
        for i in range(0,2):
            ...
            mp.spawn(run_pnas.run, args=(list(range(num_gpus)),  model_lp,    hetero_graph ,   train_mask, max_epoch ),  nprocs=num_gpus, join=True )
