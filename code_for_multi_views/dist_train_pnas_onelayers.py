...
max_epoch=360
acc_file_name=  r'clf_score_pnas_0LP1N1Tmul4_360_v1.txt'
label_known_rate=0.01 
train_rate=0.8
test_rate= 1
model_path=r'/home/xiezheng/Datasets/Sci_Papers/model_pnas_0LP1NC1Tmul4_360_v1'
...
if __name__ == '__main__':
    ...
    with open(acc_file_name, 'w') as fw:
        ...
        for i in range(0,12):
            ...
            mp.spawn(run_pnas_onelayer.run, args=(list(range(num_gpus)),  model_lp,    hetero_graph ,   train_mask, max_epoch ),  nprocs=num_gpus, join=True )
