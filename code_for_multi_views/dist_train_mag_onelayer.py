...
max_epoch=120
acc_file_name=  r'clf_score_aps_0LP1N80Tmul4_120_v1.txt'
label_known_rate=0.8
train_rate=0.8
test_rate= 1
model_path=r'/home/xiezheng/Datasets/Sci_Papers/model_aps_0LP1NC80Tmul4_120_v1'
...
if __name__ == '__main__':
    ...
    with open(acc_file_name, 'w') as fw:
        ...
        for i in range(0,7):
            model_lp = Model_LP(n_features,  num_class, hetero_graph.etypes).to(torch.device('cuda'))      
